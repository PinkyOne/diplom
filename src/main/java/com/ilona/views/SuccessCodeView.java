 ...
 * @author Alex
 */
public class SuccessCodeView extends javax.swing.JFrame {

    /**
     * Creates new form SuccessCodeView
     */
    public SuccessCodeView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuccessCodeView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SuccessCodeView().setVisible(true);
            }
        });
    }
