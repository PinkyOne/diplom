 ...
 * the same size.
 */
public class OriginalEncoder {

    public static final int DATA_SHARDS = 128;
    public static final int PARITY_SHARDS = 127;
    public static final int TOTAL_SHARDS = PARITY_SHARDS+DATA_SHARDS;
